    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						...
						{"menuid":"8","icon":"","menuname":"考勤信息管理",
							"menus":[
									{"menuid":"81","menuname":"考勤列表","icon":"icon-book-open","url":"AttendanceServlet?method=toAttendanceListView"},
								]
						},
						{"menuid":"9","icon":"","menuname":"请假信息管理",
							"menus":[
									{"menuid":"81","menuname":"请假列表","icon":"icon-book-open","url":"LeaveServlet?method=toLeaveListView"},
								]
						},
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">Copyright &copy; By hexinliu</div>
    </div>
