...
public class StudentDao extends BaseDao {
	public boolean addStudent(Student student){
		String sql = "insert into s_student values(null,'"+student.getSn()+"','"+student.getName()+"','"+student.getPassword()+"','"+student.getClazzId()+"','"+student.getSex()+"','"+student.getMobile()+"','"+student.getQq()+"',null)";
		return update(sql);
	}
