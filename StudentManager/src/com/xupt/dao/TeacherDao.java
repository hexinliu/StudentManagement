...
public class TeacherDao extends BaseDao {
	public boolean addTeacher(Teacher teacher){
		String sql = "insert into s_teacher values(null,'"+teacher.getSn()+"','"+teacher.getName()+"','"+teacher.getPassword()+"','"+teacher.getClazzId()+"','"+teacher.getSex()+"','"+teacher.getMobile()+"','"+teacher.getQq()+"',null)";
		return update(sql);
	}
